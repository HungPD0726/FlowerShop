...
function OrderSuccessContent() {
  ...
  return (
    <div className="page-shell py-16 text-center sm:py-24">
      ...
      <p className="eyebrow mt-7">Cảm ơn bạn đã chọn Lá & Hoa</p>
      ...
      <div className="mx-auto mt-9 max-w-xl rounded-2xl border border-line bg-surface p-6 text-left text-sm leading-7 text-muted"><p>Cửa hàng sẽ xử lý theo thông tin người nhận, ngày giao và khung giờ bạn đã chọn.</p><p className="mt-3">Bạn có thể theo dõi trạng thái trong tài khoản hoặc liên hệ cửa hàng với mã đơn ở trên.</p></div>
